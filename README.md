# 목차
1.[프로젝트 개요](#1장-프로젝트-개요)
  * [배경](#1-1-배경)
  * [목적](#1-2-목적)
  * [효용가능성](#1-3-효용가능성)

 2.[환경 구성](#2장-환경-구성)
  * [Remote PC](#2-1-Remote-PC)
  * [라즈베리 파이 3 B+ (Turtlebot 3 Waffle Pi)](#2-2-라즈베리-파이-3-B+-(Turtlebot-3-Waffle-Pi))
  * [Remote PC 에서 라즈베리 파이로 접속](#2-3-Remote-PC-에서-라즈베리-파이로-접속)
  * [코드 구동 순서](#2-4-코드-구동-순서)
 ...
 4.[기능구현 A – 차선검출 & 주행](#4장-기능구현-A-차선검출-&-주행)
  * [차선 검출 방법](#4-1-차선-검출-방법)
  * [모터제어와 주행](#4-2-모터제어와-주행)

5.[기능구현 B – 딥러닝을 활용한 표지판 인식](#5장-기능구현-B-–-딥러닝을-활용한-표지판-인식)
  * [데이터 수집 및 분석](#5-1-데이터-수집-및-분석)
  * [모델 설계 및 채택이유](#5-2-모델-설계-및-채택이유)
  * [프로세스](#5-3-프로세스)

6.[한계점 및 향후계획](#6장-한계점-및-향후계획)
...
## 2-2 라즈베리 파이 3 B+ (Turtlebot 3 Waffle Pi)
Raspbian Stretch OS  설치

## 2-3 Remote PC 에서 라즈베리 파이로 접속
